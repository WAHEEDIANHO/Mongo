...
namespace Mongo.Services.ShoppingCartAPI.Extension
{
    public static class WebApplicationBuilderExtension
    {
        ...
        public static WebApplicationBuilder AddHttpClientExtention (this WebApplicationBuilder builder)
        {;
            builder.Services.AddHttpClient("ProductAPI", u => u.BaseAddress = new Uri(builder.Configuration["ServiceUrl:ProductAPI"]));
            builder.Services.AddHttpClient("CouponAPI", u => u.BaseAddress = new Uri(builder.Configuration["ServiceUrl:CouponAPI"]));
