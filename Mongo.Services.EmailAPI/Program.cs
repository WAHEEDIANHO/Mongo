...
builder.Services.AddSingleton(new EmailService(dbOption.Options));

//since AppDbContext is a scope variable can't be access from form our AzureServiceBusConsumer implemantation
